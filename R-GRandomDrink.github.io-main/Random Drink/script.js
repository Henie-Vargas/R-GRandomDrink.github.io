...
//Lotus
if(document.getElementById('lotus-check').checked==true && document.getElementById('SF').checked==true && document.getElementById('two-syrups').checked==true){
    return getDrink().innerHTML="How about A...   " + allSyrups[3][Math.floor(Math.random()*fruitySF.length)] +' - '+ allSyrups[3][Math.floor(Math.random()*fruitySF.length)] + " Lotus?"
}else if(document.getElementById('lotus-check').checked==true && document.getElementById('SF').checked==true){
    return getDrink().innerHTML="How about A...   " + allSyrups[3][Math.floor(Math.random()*fruitySF.length)] + " Lotus?"
}else if(document.getElementById('lotus-check').checked==true && document.getElementById('two-syrups').checked ==true){
...
//Non Caff
}else if(document.getElementById('noCaff').checked == true && document.getElementById('two-syrups').checked==true && document.getElementById('SF').checked==true){
    return getDrink().innerHTML="How about A...    " + allSyrups[3][Math.floor(Math.random()*fruitySF.length)] +' - ' + allSyrups[3][Math.floor(Math.random()*fruitySF.length)] + ' ' +  allDrinks[1][Math.floor(Math.random()*nonCaff.length)] + '?'
}else if(document.getElementById('noCaff').checked == true && document.getElementById('SF').checked==true){
        return getDrink().innerHTML="How about A...    " + allSyrups[3][Math.floor(Math.random()*fruitySF.length)] +' ' +  allDrinks[1][Math.floor(Math.random()*nonCaff.length)] + '?'
}else if(document.getElementById('noCaff').checked==true && document.getElementById('two-syrups').checked==true){
        return getDrink().innerHTML="How about A...    " + allSyrups[2][Math.floor(Math.random()*fruity.length)] +' - ' + allSyrups[2][Math.floor(Math.random()*fruity.length)] + ' ' +  allDrinks[1][Math.floor(Math.random()*nonCaff.length)] + '?'
    }else if(document.getElementById('noCaff').checked==true){
        return getDrink().innerHTML="How about A...    " + allSyrups[2][Math.floor(Math.random()*fruity.length)] + ' '+allDrinks[1][Math.floor(Math.random()*nonCaff.length)]+'?'
//Sugar Free
